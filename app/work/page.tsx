    ...
    <>
      {projectsPage?.pageBuilder?.length ? (
        ...
        <>
          ...
          <FullScreenSection>
            <div className="text-center mb-12 bg-card border border-border shadow-lg p-12 max-w-4xl mx-auto rounded-md">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="text-center p-8 bg-card border border-border shadow-lg rounded-md">
                <p className="text-muted-foreground font-bold">No projects configured yet. Please set up your projects page in Sanity Studio.</p>
              </div>
            </div>
          </FullScreenSection>
        </>
